...
if 'gpt' in model_name and 'azure' not in model_name:
    output_folder = f"Outputs/Type_A_News/azure--{model_name_for_output_folder}/{BADGE_TO_USE}/{SEED}/"
    os.makedirs(output_folder, exist_ok=True)
else:
    output_folder = f"Outputs/Type_A_News/{model_name_for_output_folder}/{BADGE_TO_USE}/{SEED}/"
    os.makedirs(output_folder, exist_ok=True)
