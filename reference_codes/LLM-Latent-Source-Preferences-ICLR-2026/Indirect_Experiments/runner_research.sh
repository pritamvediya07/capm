...
data_domains=("Computer Vision and Pattern Recognition" "Computational Linguistics" "Health & Medical Sciences" "Physics & Mathematics" "Social Sciences")
    ...
    for i in $(seq 1 "$ITERATIONS"); do
        ...
        for badge in "${badges[@]}"; do
            for data_domain in "${data_domains[@]}"; do
                ...
                CUDA_VISIBLE_DEVICES=$gpu python3 run_research.py \
