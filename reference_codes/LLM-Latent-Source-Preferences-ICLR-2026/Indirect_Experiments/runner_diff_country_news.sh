...
data_domains=("Liesure_and_Entertainment" "Politics_and_Policy" "Science_Technology_and_Breakthroughs" "Economics_and_Financial_Trends" "Athletics_and_Sports_Event")
    ...
    for i in $(seq 1 "$ITERATIONS"); do
        ...
        for badge in "${badges[@]}"; do
            for data_domain in "${data_domains[@]}"; do
                ...
                CUDA_VISIBLE_DEVICES=$gpu python3 run_diff_country_news.py \
