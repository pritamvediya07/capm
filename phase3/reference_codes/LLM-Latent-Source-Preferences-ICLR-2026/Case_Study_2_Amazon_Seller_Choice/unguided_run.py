...
if 'gpt' in model_name and 'azure' not in model_name:
    output_folder = f"Outputs/Type_Case_Study_2_Amazon/azure--{model_name.split('/')[-1]}/Ambiguous/{seed}/"
    os.makedirs(output_folder, exist_ok=True)
else:
    output_folder = f"Outputs/Type_Case_Study_2_Amazon/{model_name.split('/')[-1]}/Ambiguous/{seed}/"
    os.makedirs(output_folder, exist_ok=True)
